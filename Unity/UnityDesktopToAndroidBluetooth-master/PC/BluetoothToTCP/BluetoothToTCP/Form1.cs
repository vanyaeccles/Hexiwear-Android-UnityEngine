...
namespace BluetoothToTCP
{
    public partial class Form1 : Form
    {
        ...
        public void setLastTCPMessage(byte[] text)
        {
            //TCPLastMessageTB.Text = text;
        }

        public void setLastBTMessage(byte[] text)
        {
            BTLastMessageTB.Text = text.ToString();
        }


        public void setLastBTMessageString(string text)
        {
